...
| `test_invariant_fqn_citation.py` | 소유 문서 밖 맨 불변식 인용(모호 구간 1~9)의 **증가**를 막는 래칫 — 기존 91건은 BASELINE 동결(등록부 append-only 규약), 감소 시 갱신 강제. `identifier_scan` 의 둘째 소비자 | WIRED_PYTEST | `docs/IDENTIFIER_REGISTER.md` |
