...
- **발송 후 정정 이력(2026-08-24)** — 이 문서는 상신된 뒤 세 번 수정됐다.
  주장을 철회한 것이 아니라 강도·범위를 정확히 한 것이며, 각 자리에 정정
  블록으로 표시돼 있다: ① §4의 "원리적 불가"로의 확대 금지(D-33-V §7) ·
  ② §7의 측정 한계 둘을 닫음(Q34-B) · ③ §1 framing을 판정이 준 대칭 문장으로
  교체하고 양방향 부등식을 실음(D-34 §3).
